...
class StoryList {
  ...
  async addStory(user, { title, author, url }) {
    ...
    const story = new Story(resonse.data.story);
  ...
  async removeStory(user, storyID) {
    ...
    // do thhe same thing for the user's list of stories and their favorites 
...
class User {
  ...
  /** add a sotry to the list of user favorites and update the API
   * -story: a Story instance to add to favoritese
   */
